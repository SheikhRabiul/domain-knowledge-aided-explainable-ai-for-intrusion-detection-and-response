...
# import data
dataset = pd.read_csv('data/result_numeric_50000.csv', sep=',')
...
X,X_test,y,y_test = train_test_split(X,y, test_size = .95, random_state=42, shuffle = True, stratify = y ) 
...
#configure here
selected_algorithm =2 # 1= extra trees, 2 = random Forest
