...
X_train = np.load('data/data_fully_processed_X_train_resampled_all_features.npy')
y_train = np.load('data/data_fully_processed_y_train_resampled_all_features.npy')
X_test = np.load('data/data_fully_processed_X_test_all_features.npy')
y_test = np.load('data/data_fully_processed_y_test_all_features.npy')
...
f_name = 'selected_features_with_rank.csv'
