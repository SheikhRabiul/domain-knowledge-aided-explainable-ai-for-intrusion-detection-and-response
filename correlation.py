...
X_train = np.load('data/data_fully_processed_X_train_resampled_domain_features.npy')
y_train = np.load('data/data_fully_processed_y_train_resampled_domain_features.npy')
...
corr = data.corr()
corr.to_csv("data/correlation_matrix_300000_new.csv", sep=',')
fig = plt.figure()
